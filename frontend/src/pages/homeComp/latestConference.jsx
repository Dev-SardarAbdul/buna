    ...
    <LatestConferenceSection>
      <Container>
        <div className="platform-header">
          {langData.lang == "ltr" ? (
            <PlatformTitle>Latest Conferences</PlatformTitle>
          ) : (
            <PlatformTitle>الفعاليات والمؤتمرات</PlatformTitle>
          )}
          {langData.lang == "ltr" ? (
            <ExploreBtn
              onClick={() => {
            ...
            >
              {newData &&
                newData.map((item, index) => (
                  <Col lg={3}>
                    <SwiperSlide>
                      <ConferencesCard item={item} index={index} />
                    </SwiperSlide>
                  </Col>
                ))}
            </Swiper>
...
export default LatestConferenceComp;
