...
import { AudioDiv, DetailSection } from "./elements";
import img1 from "../../assets/images/playingvideodetail.png";
import img from "../../assets/images/platformvideo.png";
import img11 from "../../assets/images/podcasts/img1.png";
...
const PlayingVideoDetail = () => {
  ...
  return (
    <VideoSections className="detailNoPadding">
            ...
            <div className="textDetailContainer">
              ...
              {langData.lang == "ltr" ? (
                <Description>
                  ...
                  others to critically engage with key themes. Resources may not
                  reflect the Institute's views.
                </Description>
              ) : (
                <Description>
...
export default PlayingVideoDetail;
