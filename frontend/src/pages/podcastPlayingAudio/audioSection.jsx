...
import audio1 from "../../assets/audio/sound.mp3";
import audio2 from "../../assets/audio/sound3.mp3";
import audio3 from "../../assets/audio/sound4.mp3";
import skipRepeat from "../../assets/images/skipRepeatImg.png";
    ...
    <VideoSections className="noPadding">
      <Container className="videoContainer">
        <div className="video-data">
          <Row>
            <Col xl={4}>
              <img className="img-fluid skipRepeat" src={skipRepeat} />
            </Col>
            <Col xl={8}>
              <div>
                <MarketingText>
                ...
                {langData.lang == "ltr" ? (
                  <Description>
                    ...
                    wide range of perspectives on the future of work.The Hub
                    surfaces different voices and forms of research to enable
                    others to critically engage with key themes. Resources may
                    not reflect the Institute's views.
                  </Description>
                ) : (
                  <Description>
                    مرحبًا بكم في مركز المعرفة التابع لمعهد مستقبل العمل. ستجد
                    هنا مجموعة من الموارد التي تمثل مجموعة واسعة من وجهات النظر
                    حول مستقبل العمل. يعرض المحور أصواتًا وأشكالًا مختلفة من
                    البحث لتمكين الآخرين من المشاركة بشكل نقدي في الموضوعات
                ...
                <div className="video-info">
                  <div className="icon-div">
                    ...
                    <span>
                      {" "}
                      {langData.lang == "ltr" ? "Subscribe" : "اشترك"}{" "}
                    </span>
                  </div>
                  <div className="icon-div">
                    <Hearticon color="#DE595D" />
                    <span>
                      {langData.lang == "ltr" ? "123 likes" : "123 إعجاب"}{" "}
                    </span>
                  </div>
                  <div className="icon-div">
                    <Shareicon />
